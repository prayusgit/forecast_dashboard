    ...
    match type:
        case 'category_amount':
            ...
            if model_category_amount is None:
                with open(r"E:\esewa\forecast_dashboard\modeling\ML\models\xgb_model_category_amount.pkl", "rb") as f:
        ...
        case 'category_count':
            ...
            if model_category_count is None:
                with open(r"E:\esewa\forecast_dashboard\modeling\ML\models\xgb_model_category_count.pkl", "rb") as f:
        ...
        case 'product_amount':
            ...
            if model_product_amount is None:
                with open(r"E:\esewa\forecast_dashboard\modeling\ML\models\xgb_model_product_amount.pkl", "rb") as f:
